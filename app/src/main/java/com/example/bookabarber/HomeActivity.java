...
import com.example.bookabarber.Fragments.HomeFragment;
import com.example.bookabarber.Fragments.ShoppingFragment;
                                    ...
                                    .addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                                        ...
                                        public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                            if (task.isSuccessful()) {
                                                ...
                                                {
                                                    //If user is already available in our system
